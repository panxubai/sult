...
// };
  ...
  onLoadXq:function(id){
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        let styleVal1, styleVal2, relationVal1, relationVal2;
        if (res.data.visit_time.split(0).length == 3){
          styleVal1 = parseInt(res.data.visit_time.split(0)[0]);
          styleVal2 = 0;
          relationVal1 = parseInt(res.data.visit_time.split(0)[1]);
          relationVal2 = 0;
        } else if (res.data.visit_time.split(0).length == 4){
          if (res.data.visit_time.split(0)[0] == ""){
            styleVal1 = 0;
            styleVal2 = 0;
            relationVal1 = parseInt(res.data.visit_time.split(0)[2]);
           relationVal2 = 0;
          }else{
            styleVal1 = parseInt(res.data.visit_time.split(0)[0]);
            styleVal2 = 0;
          ...
          styleVal1 = parseInt(res.data.visit_time.slice(0, 1));
          styleVal2 = 0;
          relationVal1 = parseInt(res.data.visit_time.slice(2, 3));
          relationVal2 = 0;
        }
  ...
  floorInput: function (e) {
    this.setData({
      floorText: e.detail.value
    })
  },
  //总楼层
  cfloorSumInput: function (e) {
    this.setData({
